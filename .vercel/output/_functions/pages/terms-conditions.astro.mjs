...
const $$TermsConditions = createComponent(($$result, $$props, $$slots) => {
  ...
  const pageDescription = "Terms and Conditions for TamilKathai - Rules and regulations for using our website.";
  const pubDate = /* @__PURE__ */ new Date("August 08 2021");
  return renderTemplate`${renderComponent($$result, "Layout", $$BlogPost, { "title": pageTitle, "description": pageDescription, "pubDate": pubDate }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<h2>Terms and Conditions</h2> <p>Welcome to TamilKathai!</p> <p>
These terms and conditions outline the rules and regulations for the use
        of TamilKathai's Website, located at https://tamilkathai.in.
</p> <p>
By accessing this website, we assume you accept these terms and
        conditions. Do not continue to use TamilKathai if you do not agree to
...
We employ the use of cookies. By accessing TamilKathai, you agreed to
        use cookies in agreement with the TamilKathai's Privacy Policy.
</p> <p>
...
Unless otherwise stated, TamilKathai and/or its licensors own the
        intellectual property rights for all material on TamilKathai. All
        intellectual property rights are reserved. You may access this from
        TamilKathai for your own personal use subjected to restrictions set in
        these terms and conditions.
</p> <p>You must not:</p> <ul> <li>Republish material from TamilKathai</li> <li>Sell, rent or sub-license material from TamilKathai</li> <li>Reproduce, duplicate or copy material from TamilKathai</li> <li>Redistribute content from TamilKathai</li> </ul> <p>This Agreement shall begin on the date hereof.</p> <h3>Hyperlinking to our Content</h3> <p>
...
We will approve link requests from these organizations if we decide
        ...
        the hyperlink compensates the absence of TamilKathai; and (d) the link
...
If you are one of the organizations listed in paragraph 2 above and are
        ...
        e-mail to TamilKathai. Please include your name, your organization name,
...
</p> <p>Approved organizations may hyperlink to our Website as follows:</p> <ul> <li>By use of our corporate name; or</li> <li>By use of the uniform resource locator being linked to; or</li> <li>
By use of any other description of our Website being linked to that
            makes sense within the context and format of content on the linking
            party’s site.
</li> </ul> <p>
No use of TamilKathai's logo or other artwork will be allowed for
...
</p> <h3>Reservation of Rights</h3> <p>
...
}, "/Users/bipulkumar/Documents/WebsiteUpdate/Tamil_Story/src/pages/terms-conditions.astro", void 0);

const $$file = "/Users/bipulkumar/Documents/WebsiteUpdate/Tamil_Story/src/pages/terms-conditions.astro";
